...
{
// save most distant point from center in this angle span. You can consider it as an end of a polygon
class QuarterView
{
 public:
  int id;
  int min_ang; // angle span
  int max_ang;
  PlannerHNS::WayPoint max_from_center; // most distance
  bool bFirst;
...
class PolygonGenerator
{
 public:
  ...
  std::vector<QuarterView> m_Quarters;         // Divide plane XOY into sectors by angle. This is num of sectors.
  std::vector<PlannerHNS::GPSPoint> m_Polygon; // store ends of convex polygon
