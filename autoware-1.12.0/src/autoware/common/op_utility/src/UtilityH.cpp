...
double UtilityH::FixNegativeAngle(const double &a) // ensure 0<=a<=2PI
{
  double angle = 0;
...
// get current system time(from 1970)
...
{
  long nanoDiff =
      (time1.tv_sec * 1000000000 + time1.tv_nsec) - (time2.tv_sec * 1000000000 + time2.tv_nsec);
